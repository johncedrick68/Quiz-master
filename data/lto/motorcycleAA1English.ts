...
const rows: Row[] = [
  ...
  ['What does this traffic sign mean?', 2, 'Pedestrian crossing', 'Starting point for walking', 'Traffic light signals ahead'],
  ...
  ['What does this traffic light mean?', 1, 'Come to a complete stop', 'Slow down and proceed if there is no danger', 'Ignore the light and maintain your current speed'],
  ...
  ['Where would you normally see this sign?', 1, 'Commercial business center', 'School pedestrian crossing', 'Airport cargo runway approach'],
  ...
  ['What does this traffic sign mean?', 0, 'Stop', 'Do not enter', 'No entry for all types of vehicles'],
  ...
  ['What does this traffic sign mean?', 0, 'Dangerous right curve', 'Dangerous left curve', 'Dangerous curve'],
  ...
  ['What does this traffic sign mean?', 2, 'No cars', 'Cars only', 'No motorcycles'],
  ...
  ['What does this traffic sign mean?', 1, 'Keep distance', 'No overtaking', 'Two-way traffic ahead'],
  ['A driver has an arm out the window bent upward. What is the intention?', 1, 'Turn left', 'Turn right', 'Stop'],
  ['What does this traffic sign mean?', 2, 'No swerving', 'Change lane', 'Dangerous curve ahead'],
  ...
  ['What does this traffic sign mean?', 0, 'No U-turn', 'Dangerous left bend', 'Dangerous right bend'],
