const rules: [RegExp, string][] = [
  ...
  [/slippery road|madulas.*kalsada/i, '/images/Philippines-Warning-Sign-Warning-for-a-slippery-road-surface.webp'],
  [/road works|ginagawang kalsada/i, '/images/lto/signs/road-works.svg'],
  [/dangerous left double bend|double.*curve.*left|dobleng.*kurbada.*kaliwa/i, '/images/Philippines-Warning-Sign-Warning-for-a-double-curve--first-left-then-right.webp'],
  [/dangerous.*curve.*left|delikado.*kurbada.*kaliwa/i, '/images/Philippines-Warning-Sign-Warning-for-a-sharp-curve-to-the-left.webp'],
  [/curve ahead|kurbada.*unahan/i, '/images/Philippines-Warning-Sign-Warning-for-curves.webp'],
  [/yield|give way|magbigay.?daan/i, '/images/giveway_sign.webp'],
  [/school zone|pook paaralan|tawiran ng paaralan/i, '/images/children_crossing.webp'],
  [/no entry|bawal pumasok.*sasakyan/i, '/images/no_entry.webp'],
  [/no right turn|bawal.*kanan/i, '/images/No right turn.webp'],
  [/no motor vehicles|no entry for all types of vehicles/i, '/images/no_entry.webp'],
  [/do not overtake|no overtaking/i, '/images/No overtaking.webp'],
  [/road narrows|makitid.*daan/i, '/images/Philippines-Warning-Sign-Warning-for-a-road-narrowing.webp'],
  [/downhill course|steep descent/i, '/images/Philippines-Warning-Sign-Warning-for-a-steep-descent.webp'],
  [/dangerous right curve/i, '/images/Philippines-Warning-Sign-Warning-for-a-sharp-curve-to-the-right.webp'],
  [/approach to intersection(?!.*merging)/i, '/images/lto/signs/intersection.svg'],
  [/pass either side/i, '/images/lto/signs/pass-either-side.svg'],
  [/railroad crossing|riles ng tren|reles ng tren/i, '/images/Philippines-Warning-Sign-Warning-for-a-railroad-crossing-without-barriers.webp'],
  [/end of.*speed limit|katapusan.*speed limit|katapusan.*itinakdang bilis/i, '/images/end of speed limit.webp'],
