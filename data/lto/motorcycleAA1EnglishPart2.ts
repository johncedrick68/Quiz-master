...
const rows: Row[] = [
  ...
  ['What does this traffic sign mean?', 2, 'Hospital zone ahead', 'Approach to intersection', 'Railroad crossing'],
  ...
  ['What does this traffic sign mean?', 1, 'Two-way traffic ahead', 'Side road intersection ahead', 'Dead end ahead'],
  ...
  ['What does this traffic sign mean?', 0, 'Steep descent downhill', 'Uphill course', 'Low-clearance bridge'],
  ...
  ['What does this traffic sign mean?', 1, 'Maximum speed is 60 kph', 'Minimum speed is 60 kph', 'The next town is 60 km away'],
  ...
  ['What does this traffic sign mean?', 1, 'Winding road ahead', 'Slippery road', 'Rough road surface'],
  ...
  ['What does this traffic sign mean?', 1, 'You can stop temporarily to load items', 'No stopping unless directed by an authorized officer', 'Parking is allowed for motorcycles'],
  ['What does this traffic sign mean?', 1, 'Playground zone ahead', 'Road works ahead', 'Farming area crossing'],
  ['What does this traffic sign mean?', 1, 'Stop completely', 'Give way to other traffic', 'No entry'],
  ...
  ['What does this traffic sign mean?', 1, 'Sharp right turn', 'Dangerous right double curve', 'Winding road network entry'],
  ...
  ['What does this traffic sign mean?', 1, 'Sharp curve to the right', 'Sharp curve to the left', 'Roundabout ahead'],
  ...
  ['What does this traffic sign mean?', 0, 'Proceed straight ahead only', 'No entry', 'Turning is required'],
  ...
  ['What does this traffic sign mean?', 1, 'Dangerous right curve ahead', 'Dangerous left double bend', 'Winding road ahead'],
...
motorcycleAA1EnglishPart2[8].image = '/images/Philippines-Warning-Sign-Warning-for-a-railroad-crossing-without-barriers.webp';
motorcycleAA1EnglishPart2[14].image = '/images/No parking.webp';
